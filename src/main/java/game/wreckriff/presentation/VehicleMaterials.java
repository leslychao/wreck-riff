...
public final class VehicleMaterials {
    ...
    public static Material create(AssetManager assets,String profile,String part) {
        ...
        ColorRGBA color=glass?new ColorRGBA(.07f,.16f,.21f,1):rubber?new ColorRGBA(.16f,.16f,.17f,1):paint?ColorRGBA.White:new ColorRGBA(.80f,.83f,.86f,1);
        ...
        material.setFloat("Shininess",glass?100:rubber?5:paint?42:55);material.setFloat("NormalType",1);
