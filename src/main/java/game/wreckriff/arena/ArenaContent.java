...
public record ArenaContent(Node visual, List<StaticBody> bodies,
    ...
    public record StaticBody(String id, CollisionShape shape, Vector3f position, Quaternion rotation,List<ContactSurface> triangleSurfaces) {
        public StaticBody {triangleSurfaces=List.copyOf(triangleSurfaces);}
        public StaticBody(String id,CollisionShape shape,Vector3f position,Quaternion rotation){this(id,shape,position,rotation,List.of());}
    }
    public ArenaContent {
