...
public final class AudioCapture implements AutoCloseable {
    ...
    void observe(Object identity,String asset,boolean loop,boolean positional,float volume,float pitch,
        ...
        if(asset==null||!asset.matches("audio/(?:[a-z0-9-]+|music/(?:menu|dead-air-yard|(?:construction_17|neon_zero|euphoria_park)-(?:normal|boss)))\\.wav")||!Float.isFinite(volume)||volume<0||volume>1
