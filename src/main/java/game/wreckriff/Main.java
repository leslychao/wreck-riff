...
public final class Main {
    ...
    public static void main(String[] args) {
        if(args.length==1&&args[0].equals("--help")) { System.out.println("Wreck Riff: --dev [--seed=<long>] [--no-audio] [--ai-player] [--arena=<stable-id>] [--resolution=720p|1080p] [--no-glow] [--smoke-seconds=1..3600 | --benchmark-seconds=1..3600 | --showcase | --art-showcase] [--config-dir=<path>]"); return; }
        try {
