    ...
    @Test void foremanControlledFixturePlacesRivetInsideAnActualBoundWeaponTrajectory() {
        ...
        try(var world=new PhysicsWorld(rules)) {
            ...
            try(var runtime=new MatchRuntime(session,world,arena,content.graph(),rules)) {
                ...
                float bossDamage=0,minimumCannonClearance=Float.POSITIVE_INFINITY;int boundShots=0;
                String opening="boss did not spawn";
                ...
                System.out.println("CONTROLLED_OPENING "+opening+", boundShots="+boundShots+", damage="+bossDamage+", closestCannon="+minimumCannonClearance);
