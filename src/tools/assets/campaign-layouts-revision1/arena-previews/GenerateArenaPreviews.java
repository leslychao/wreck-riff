...
public final class GenerateArenaPreviews extends SimpleApplication {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Captured six clean real arena previews in "+output);
    }
    ...
    private void showArena() {
        ...
        cam.setFrustumPerspective(52,cam.getWidth()/(float)cam.getHeight(),.1f,650);
        cam.setLocation(centre.add(-65,47,-77));cam.lookAt(centre,Vector3f.UNIT_Y);
