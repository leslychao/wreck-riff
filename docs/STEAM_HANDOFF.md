...
Один локальный игрок и четыре AI; Rivet с пятью ливреями и двухуровневая промышленная арена; пулемёт, Homing/Power Rocket, Mine, Napalm; Freeze/Shield; ремонты/боеприпасы/hazard; результаты и Retry; локальные настройки и статистика. В 0.2 переработаны геометрия, текстуры, освещение, тени, шрифт и музыка. Игрок имеет 800 HP, боты 400 HP, перегрева и стартового отсчёта нет. Интерфейс — английский, документация разработчика — русская. Клавиатура/мышь и Xbox-совместимый GLFW-профиль предусмотрены кодом.
